...
import org.market.hedge.binance.dto.marketdata.BinancePriceQuantity;
import org.market.hedge.binance.dto.trade.BinanceOrder;
import org.market.hedge.binance.dto.trade.OrderSide;
import org.market.hedge.binance.dto.trade.OrderStatus;
import org.market.hedge.binance.service.BinanceTradeService.BinanceOrderFlags;
...
public class BinanceAdapters {
  ...
  public static Order adaptOrder(BinanceOrder order) {
    ...
    if (order.type.equals(org.market.hedge.binance.dto.trade.OrderType.MARKET)) {
      builder = new MarketOrder.Builder(type, currencyPair);
    } else if (order.type.equals(org.market.hedge.binance.dto.trade.OrderType.LIMIT)
        || order.type.equals(org.market.hedge.binance.dto.trade.OrderType.LIMIT_MAKER)) {
  ...
  public static List<Ticker> adaptPriceQuantities(List<BinancePriceQuantity> priceQuantities) {
    return priceQuantities.stream()
        .map(org.market.hedge.binance.BinanceAdapters::adaptPriceQuantity)
  ...
  public static org.market.hedge.binance.dto.trade.OrderType adaptOrderType(StopOrder order) {
    ...
    switch (order.getIntention()) {
      case STOP_LOSS:
        return order.getLimitPrice() == null
            ? org.market.hedge.binance.dto.trade.OrderType.STOP_LOSS
            : org.market.hedge.binance.dto.trade.OrderType.STOP_LOSS_LIMIT;
      case TAKE_PROFIT:
        return order.getLimitPrice() == null
            ? org.market.hedge.binance.dto.trade.OrderType.TAKE_PROFIT
            : org.market.hedge.binance.dto.trade.OrderType.TAKE_PROFIT_LIMIT;
      default:
